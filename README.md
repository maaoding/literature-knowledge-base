...
一个中文文学知识入口，用文学史、作家、作品、文学理论、文学技巧和阅读路径帮助访客建立自己的阅读路线。
...
- 独立文学风格测试入口，用 30 道本地计算的题目生成阅读画像。
...
文学风格测试使用独立仓库和域名；主站仅保留外部入口、旧地址跳转与一次性本地结果迁移桥。
